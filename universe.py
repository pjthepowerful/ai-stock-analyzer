...
EXTRAS = [
    ...
    "NNE","NTLA","NTNX","NU","OKLO","OKTA","ONON","OSCR","PATH","PINS","PLUG","PSTG","QBTS","QS",
    "RBLX","RBRK","RDDT","RGTI","RIOT","RIVN","RKLB","ROOT","RXRX","S","SE","SHOP","SMR","SNAP","SNOW","SOFI",
    "SOUN","SPOT","TEM","TOST","TTD","TWLO","U","UPST","VERX","VRT","WULF","ZETA","ZS","ZM",
    # More liquid mid/large-caps and popular movers
    "AA","AAL","ACAD","ACHC","ACI","ADT","AFG","AGCO","AGNC","AKAM","ALGM","ALKS","ALLY","ALSN","AMBA","AMC","AMKR","AN","ANF","APG","APLS","APO","AR","ARES","ARW","ARWR","ASAN","ASH","ASO","AVAV","AVTR","AXSM","AYI","AZTA",
    "BAH","BC","BCO","BDC","BFAM","BHF","BIO","BJ","BKU","BLD","BLKB","BMRN","BOKF","BPMC","BRBR","BRKR","BRX","BSY","BURL","BWXT","BYD","BZH",
    "CABO","CACC","CACI","CAR","CASY","CBSH","CCK","CFR","CGNX","CHE","CHRD","CHX","CIEN","CLF","CLH","CMC","CNM","CNX","COKE","COLB","COLM","CPRI","CR","CRC","CRI","CROX","CRUS","CSL","CVLT","CW","CXT","CYTK",
    ...
    "H","HALO","HAS","HCC","HGV","HLI","HLNE","HOG","HOMB","HQY","HRB","HUBS","HXL",
    "IART","IBKR","ICUI","IDA","IGT","ILMN","INGR","INSP","IPAR","IRDM","ITCI","ITT",
    ...
    "SAIA","SAIC","SAM","SARO","SATS","SCI","SEIC","SF","SFM","SGRY","SHC","SIG","SITM","SKX","SLGN","SLM","SM","SMG","SN","SNDR","SNV","SNX","SON","SPB","SPSC","SPXC","SSB","SSD","STAG","STEP","STNE","STRL","STWD","SWX","SXT","SYNA",
