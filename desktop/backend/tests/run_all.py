...
SUITES = ["test_signal_logic.py", "test_auth_reset.py", "test_router.py", "test_backtest.py", "test_price_math.py", "test_smallcap.py", "test_bells.py", "test_groq_models.py", "test_security.py", "test_earnings.py"]
